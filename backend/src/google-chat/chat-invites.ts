...
export function buildInviteLauncherStartedStatus(): ChatInviteSessionStatus {
  return {
    state: 'UNKNOWN',
    message:
      'Uruchomiono okno logowania Google Chat na komputerze z backendem. Zaloguj konto Google, a potem kliknij Zaladuj zaproszenia.',
    url: null,
    title: null,
